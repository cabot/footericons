...
$lang = array_merge($lang, [
	...
	'ACP_FI_APPLY_STYLE'					=> 'Appliquer le style de cette icône aux autres icônes',
	'ACP_FI_STYLES_APPLIED'					=> 'Le style de l’icône a été appliqué aux autres icônes avec succès.',
	'ACP_FI_APPLY_STYLE_CONFIRM'			=> 'Êtes-vous sûr de vouloir appliquer le style de cette icône à toutes les autres icônes ?<br><ul><li>Couleur de l’icône</li><li>Couleur de l’icône au survol</li><li>Fond de l’icône</li><li>Couleur de fond</li><li>Couleur de fond au survol</li><li>Couleur de l’ombre portée</li></ul>',
	...
	'ACP_FI_DELETE_CONFIRM'					=> 'Êtes-vous sûr de vouloir supprimer cette icône ?',
	'ACP_FI_DELETE_NO'						=> 'Restaurer',
	'ACP_FI_DELETE_YES'						=> 'Supprimer',
	'ACP_FI_DELETED'						=> 'Icône « %s » supprimée avec succès.',
	'ACP_FI_DELETE_FAILED'					=> 'Échec de la suppression de l’icône.',
	'ACP_FI_DESC'							=> 'Description de l’icône',
	'ACP_FI_DESC_EXPLAIN'					=> 'Texte informatif affiché dans une infobulle lors du survol de l’icône.',
	'ACP_FI_ENABLE'							=> 'Activer l’affichage des icônes',
	'ACP_FI_EXTERNAL_LINK'					=> 'Lien externe',
	'ACP_FI_EXTERNAL_LINK_EXPLAIN'			=> 'Sélectionnez « Oui » pour ouvrir le lien dans un nouvel onglet.',
	'ACP_FI_HEADING_ADD'					=> 'Ajouter une icône',
	'ACP_FI_HEADING_EDIT'					=> 'Modifier une icône',
	'ACP_FI_HEADING_SETTINGS'				=> 'Configuration et aperçu des icônes',
	'ACP_FI_ICON_ADD'						=> 'Ajouter une nouvelle icône',
	'ACP_FI_ICON_CLOSE'						=> 'Fermer',
	'ACP_FI_ICONS_LIST'						=> 'Liste des icônes',
	...
	'ACP_FI_URL_EXPLAIN'					=> 'Saisissez l’URL complète du lien (p. ex. https://www.phpbb-fr.com)',
	'ACP_FI_MISSING_FIELDS'					=> 'Le ou les champs suivants sont requis mais manquants :<br>%s',
	'ACP_FI_NOT_FOUND'						=> 'Icône introuvable.',
]);
